...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Product product1 = new Product("1", "Gao ST125", 30.0);
        Product product2 = new Product("2", "Nuoc mam  ", 20.0);
        Product product3 = new Product("3", "Nuoc tuong", 15.0);
        Product product4 = new Product("4", "Muoi tinh ", 14.0);
        Product product5 = new Product("5", "Keo ngot  ", 10.0);
        Product product6 = new Product("6", "Duong an  ", 22.0);
        Product product7 = new Product("7", "Tieu xanh", 10.0);
